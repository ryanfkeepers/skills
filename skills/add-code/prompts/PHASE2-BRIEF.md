...
You are an implementation agent. Phase 1 scaffolding is complete. Your job: implement
the logic for `[FEATURE]` and generate mocks from the exported interfaces.
