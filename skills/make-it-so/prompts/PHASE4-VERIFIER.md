...
Integration and E2E tests may not be fully runnable in this session: they can require live
services, external auth, or user-assisted execution. Do not claim integration coverage you
have no evidence for. Instead:
...
1. **Spec compliance** — is every requirement in the plan implemented? Identify gaps
   by requirement, not by intuition.
...
5. **Test coverage** — do contract tests verify the contracts as specified in the plan?
   Are error paths tested? Are edge cases covered?
